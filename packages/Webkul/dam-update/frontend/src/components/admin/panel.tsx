...
/** Bordered rounded-2xl panel shell used across the admin console. */
...
/** Shared table style tokens for admin data tables. */
export const TABLE_HEAD_CLASS = "font-mono text-[11px] uppercase tracking-[0.16em] text-muted-foreground";
export const ROW_HOVER_CLASS = "hover:bg-accent/50";
