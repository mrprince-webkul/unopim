...
return [
    ...
    'aws' => [
        'document' => [
            ...
            'index' => [
                ...
                'description' => 'O Amazon S3 é um serviço de armazenamento de objetos que oferece escalabilidade líder na indústria, elevada disponibilidade de dados, segurança e desempenho.',
            ],
            'setup' => [
                'title' => 'Como Configurar',
                'steps' => [
                    'step1' => 'Crie um bucket S3 na sua conta AWS.',
                    'step2' => 'Gere a Access Key e a Secret Key através do IAM.',
                    'step3' => 'Configure as credenciais AWS no UnoPim.',
                ],
            ],
            'migration' => [
                'title'            => 'Migrar Média Existente para AWS S3',
                'migrate-existing' => 'Para migrar a média existente do UnoPim para o AWS S3, execute o seguinte comando:',
                'remove-migrated'  => 'Para remover os ficheiros de média do armazenamento local após a migração, execute:',
            ],
            'visibility' => [
        ...
        'credential' => [
            ...
            'save-success' => 'Credenciais AWS guardadas com sucesso',
        ],
        'history' => [
    ...
    'acl' => [
        'credential' => [
            'view' => 'Ver Credenciais AWS',
            'save' => 'Guardar Credenciais AWS',
        ],
    ],
];
